...
async function main() {
    ...
    const ashutosh = await prisma.user.create({
        data: {
            ...
            password: (0, bcryptjs_1.hashSync)("member123", 10),
    ...
    const projectAlpha = await prisma.project.create({
        data: {
            name: "Project Alpha",
            description: "A flagship product launch with comprehensive marketing and development milestones.",
    ...
    const projectBeta = await prisma.project.create({
        data: {
            name: "Project Beta",
            description: "Internal tooling overhaul to improve developer experience and CI/CD pipelines.",
            createdById: admin.id,
        },
    });
    ...
    const tasks = await Promise.all([
        prisma.task.create({
            data: {
                ...
                description: "Create high-fidelity mockups for the new product landing page in Figma.",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Build login, register, and password reset flows with JWT tokens.",
        ...
        prisma.task.create({
            data: {
                ...
                description: "Review and optimize database indexes for frequently queried columns.",
                status: client_1.TaskStatus.TODO,
        ...
        prisma.task.create({
            data: {
                ...
                description: "Migrate notification service from polling to WebSocket-based real-time updates.",
                status: client_1.TaskStatus.IN_PROGRESS,
                priority: client_1.Priority.MEDIUM,
